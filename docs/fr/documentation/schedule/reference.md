...
## Table des matières 
 ...
 2. [Fichiers du Dataset](#fichiers-du-dataset) 
 3. [Exigences relatives aux fichiers](#exigences-relatives-aux-fichiers) 
 4. [Publication des ensembles de données et pratiques générales](#publication-des-ensembles-de-donnees-et-pratiques-generales) 
 ...
 * La première ligne de chaque fichier doit contenir des noms de champs. Chaque sous-section de la section [Définitions des champs](#definitions-des-champs) correspond à l’un des fichiers d’un ensemble de données GTFS et répertorie les noms de champs qui peuvent être utilisés dans ce fichier. 
