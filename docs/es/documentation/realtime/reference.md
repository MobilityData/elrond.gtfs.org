 ...
 **Campos** 
 ...
 | **incrementality** | [Incrementality](#enum-incrementalidad) | Obligatorio | Uno | 
 ...
 **Campos** 
 ...
 | **trip_properties** | [TripProperties](#message-properties de viaje) | Opcional | Uno | Proporciona las propiedades actualizadas para el viaje.<br><br> **Precaución:**este message aún es **experimental** y está sujeto a cambios. Es posible que se adopte formalmente en el futuro. | 
 ...
 **Campos** 
 ...
 | **current_status** | [VehicleStopStatus](#enum-estado de parada del vehículo) | Opcional | Uno | El estado exacto del vehículo respecto a la parada actual. Se ignora si falta current_stop_sequence. | 
 ...
 | **congestion_level** | [CongestionLevel](#enum-nivel de congestión) | Opcional | Uno | 
 ...
 **Campos** 
 ...
 | **cause** | [Cause](#enum-causa) | Condicionalmente Obligatorio | Uno | Si se incluye cause_detail, también se debe incluir la Causa. 
 ...
 | **severity_level** | [SeverityLevel](#enum-nivel de gravedad) | Opcional | Uno | Gravedad de la alerta. | 
 ...
 **Campos** 
 ...
 | **wheelchair_accessible** | [WheelchairAccessible](#enum-accesible en silla de ruedas) | Opcional | Uno | Si se proporciona, puede sobrescribir el valor *accesible para sillas de ruedas* del GTFS estático. | 
 ...
 **Campos** 
 ...
 | _**Nombre de campo**_ | _**Tipo**_ | _**Obligatorio**_ | _**Cardenalidad**_ | _**Descripción**_ | 
 |------------------|------------|----------------|-------------------|-------------------| 
 | **localized_image** | [LocalizedImage](#message-imagen localizada) | Obligatorio | Muchos | Se debe proporcionar al menos una imagen localizada. | 
 ...
 **Campos** 
 ...
 | **wheelchair_boarding** | [WheelchairBoarding](#enum-embarque en silla de ruedas) | Opcional | Uno | Consulte la definición de [stops.wheelchair_boarding](https://github.com/google/transit/blob/master/gtfs/spec/en/reference.md#stopstxt) en (CSV) GTFS. | 
 ...
 **Campos** 
 ...
 | _**Nombre de campo**_ | _**Tipo**_ | _**Obligatorio**_ | _**Cardenalidad**_ | _**Descripción**_ | 
 |------------------|------------|----------------|-------------------|-------------------| 
 | **selected_trips** | [SelectedTrips](#message-viajes seleccionados) | Obligatorio | Muchos | Una lista de viajes seleccionados afectados por estas TripModifications. Debe contener al menos un `s`. Si se establece el valor `start_times`, se puede enumerar un máximo de un `SelectedTrips` con un trip_id. | 
