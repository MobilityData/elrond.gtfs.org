...
## Archivos de conjunto de datos 
 ...
 | [location_groups.txt](#ubicación_grupostxt) | Opcional | Un grupo de paradas que en conjunto indican lugares donde un pasajero puede solicitar que lo recojan o lo dejen. | 
...
### stop_times.txt 
 ...
 | `timepoint` | Enumeración | Recomendado | Indica si los horarios de llegada y salida de una parada son estrictamente respetados por el vehículo o son horarios aproximados y/o interpolados. Este campo permite a un productor GTFS proporcionar tiempos de parada interpolados, al tiempo que indica que los tiempos son aproximados. Las opciones válidas son:<br><br> `0` - Los tiempos se consideran aproximados.<br> `1` o vacío: los tiempos se consideran exactos. | 
