...
<p style="font-size:16px"> 
 В следующем примере определены две службы (будние дни и выходные дни) на июль 2024 г., включая специальную праздничную службу 4 июля, работающую как службу выходного дня. 
</p> 
 !!! примечание "" 
<p style="font-size:16px"> 
...
## Время остановок 
 ...
 | Файлы включены | Поля включены | 
 |----------------------------------|-------------------| 
 |[stop_times.txt](../../../documentation/schedule/reference/#stop_timesxt)| `trip_id`, `arrival_time, `departure_time`, `stop_id`, `stop_sequence`, `pickup_type, `drop_off_type, `timepoint| 
